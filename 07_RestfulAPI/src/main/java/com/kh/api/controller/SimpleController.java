 ...
 * - 하나의 URI는 하나의 고유하 리소스(Resource)를 대표하도록 설계하는 전송 방식 
 ...
 * - 메서드의 리턴 타입으로 사용자가 정의하 ㄴ클래스 타입도 사용할 수 있고,
...
public class SimpleController {
	...
	public Map<Integer, Person> sendGreet(){
		...
		map.put(1, new Person("노석우","집가고싶다!"));
		return map;			
	}
}
